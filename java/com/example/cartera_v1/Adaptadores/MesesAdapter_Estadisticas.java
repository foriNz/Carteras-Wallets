...
public class MesesAdapter_Estadisticas extends RecyclerView.Adapter<MesesAdapter_Estadisticas.MesViewHolder> {
    ...
    Integer[] listaUsos;
    String[] meses;
    AplicarEleccionMes listener;

    public MesesAdapter_Estadisticas(Context context, Integer[] listaUsos, AplicarEleccionMes listener) {
            ...
            ll_item_mes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (context instanceof EstadisticasCartera)
                        ...
                        listener.aplicarEleccionMes(mes.getText().toString());
                }
            });
        }
    }
    public interface AplicarEleccionMes {
        void aplicarEleccionMes(String mes);
    }
}
